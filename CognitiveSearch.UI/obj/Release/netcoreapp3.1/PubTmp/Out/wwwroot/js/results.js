...
function UpdateResults(data) {
    ...
    for (var i = 0; i < data.results.length; i++) {
        ...
        if (path !== null) {
            ...
            if (pathLower.includes("/mailing-lists/")) {
                if (pathLower.includes(".json")) {
                    // Skip raw JSON results in the mailing lists. Just show HTML ones
                    continue;
                }
            }
            ...
            // Set icon based on source, primarily:
            if (pathLower.includes("/websites/")) {
